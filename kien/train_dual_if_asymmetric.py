...
BASE_FEATURES = [
    ...
    'ag_6', 'ag_7', 'ag_8', 'ag_9', 'ag_10',
    'maintainability_index', 'internal_fan_out', 'token_count',
    'llm_greeting', 'function_length_cv', 'debug_artifact_score', 
    'function_count'
]
...
def run_asymmetric_ensemble_with_if():
    ...
    # (Có thể tái sử dụng ngay biến X_test_final ở trên nhưng mô phỏng lại luồng inference)
